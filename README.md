...
<img src="https://render.githubusercontent.com/render/math?math=\large P(82 \leq X \leq 85) = \int_{82}^{85} f_x(x) dx \geq 0"> 
...
<img src="https://render.githubusercontent.com/render/math?math=\large F(x) = P(X \leq x)">
...
The idea is that
<img src="https://render.githubusercontent.com/render/math?math=\large P(82 \leq X \leq 85) = P(X \leq 85) - P(X \leq 82)= F_X(85)- F_X(82)">

This means that you can look at the y-value of your cumulative density function to get the answer to this question.

<img src="https://render.githubusercontent.com/render/math?math=\large F_X(85)- F_X(82) \approx 0.95-0.6 = 0.35">
